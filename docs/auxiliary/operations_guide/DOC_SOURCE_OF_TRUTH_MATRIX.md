...
| DB user provisioning (`appuser`) | `infra/envs/prod/db_bootstrap.tf`, `infra/envs/prod/lambda/db_bootstrap/main.py`, `infra/envs/prod/lambda/db_bootstrap/pymysql/`, `infra/envs/prod/secrets.tf` (header comment), `infra/envs/prod/rds.tf` (header comment) | `docs/auxiliary/adr/0005-secret-rotation.md`, `docs/auxiliary/adr/0008-mysql-8-4-upgrade.md`, `docs/auxiliary/operations_guide/runbooks/2026-05-08_appuser_auth_plugin_conversion.md`, `docs/auxiliary/operations_guide/runbooks/2026-05-10_asg_flapping_investigation.md`, `docs/auxiliary/operations_guide/04-operations.md` |
